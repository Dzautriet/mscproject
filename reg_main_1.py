# -*- coding: utf-8 -*-
"""
Created on Wed Jun 24 22:44:36 2020
...
# lr_scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer_cm, milestones=[5, 50, 200], gamma=0.1)
...
# call_train(X_train, valid_range, labels_train, X_vali, labels_vali, y_vali, X_test, y_test, use_pretrained=False, model=None, use_aug=False)
